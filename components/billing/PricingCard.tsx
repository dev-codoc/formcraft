  ...
  return (
    <Card
      className={cn(
        ...
        isPopular && "border-clay shadow-md"
      )}
    >
      {isPopular && (
        <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 rounded-full bg-clay px-2.5 py-0.5 text-[11px] font-medium text-ink">
          Most popular
        </div>
      )}
